// ===============================
//  FOX ENGINE – SCENARIOS (FORMAT CHAUVEL)
// ===============================
//
//  Tu peux coller ici autant de scénarios que tu veux.
//  Format validé :
//  {
//    id: number,
//    name: string,
...
// ===============================
//
//  Pour l’instant, il ne déclenche rien automatiquement.
//  Tu pourras ajouter des conditions plus tard.
//
// ===============================
...
function foxScenarioEngine(gameState) {
  ...
  // Exemple : aucun scénario déclenché automatiquement
  // Tu pourras ajouter tes règles ici plus tard.
